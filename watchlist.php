        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    <li class="" class="nav-item"><a href="index.php">Home</a></li>
                    ...
                    <li class="nav-item"><a href="search.php"><span class="glyphicon glyphicon-search"></span> Search</a></li>
                </ul>
...
<script type="text/javascript">
        ...
        xmlhttp.onreadystatechange = function() {
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                for (x in myObj.results ) {
                    ...
                    html+="<div class='col-md-6 col-sm-6 col-xs-12 col-lg-2  text-light'><div class='wMB mx-auto'><a href='#' class='browse-movie-link'><figure><img class='img-responsive' src='http://image.tmdb.org/t/p/w500/"+data[x].poster_path+"'alt=' Image not found' width='210' height='315'><figcaption class='hidden-xs hidden-sm'><div class='text-center py-3'><h3 >"+data[x].title+"</h3><h3>"+data[x].vote_average+"/10</h3><h3>Adventure</h3><div class='py-4'><span class='btn btn-outline-secondary  colBase'>View Details</span></div</div></figcaption></figure></a></div></div>";
                    if(x!=0 &&  x%6==5){
                        html +="</div>";
                    }
                }
    ...
    function trending(){
        ...
        xmlhttp.onreadystatechange = function() {
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                for (x in myObj.results) {
                    ...
                    html+="<div class='col-md-6 col-sm-6 col-xs-12 col-lg-2  text-light'>" +
                        "<div class='wMB mx-auto'>" +
                        "<a href='moviedetail.php?mid="+data[x].mid+"' class='browse-movie-link'><figure><img class='img-responsive' src='"+data[x].poster+"'alt='' width='210' height='315'><figcaption class='hidden-xs hidden-sm'><div class='text-center py-3'><h3 >"+data[x].title+"</h3><h3>"+data[x].vote+"/10</h3><h3>"+data[x].genere+"</h3><div class='py-4'></div></figcaption></figure></a>" +
                        "</div></div>";
                    if(x!=0 &&  x%6==5){
                        html +="</div>";
                    }
        ...
        xmlhttp.open("GET", "watchlistservice.php", true);
        xmlhttp.send();
